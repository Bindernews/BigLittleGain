...
def main():
  ...
  plistpath = scriptpath + "/resources/BigLittleGain-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BigLittleGain-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BigLittleGain-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BigLittleGain-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/BigLittleGain-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/BigLittleGain.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/BigLittleGain.iss",inplace=1):
